...
import bd.edu.fcub.mahfuz.CGPA.cgpaActivity;
import bd.edu.fcub.mahfuz.navactivity.LoginActivity;
import bd.edu.fcub.mahfuz.navactivity.aboutActivity;
import bd.edu.fcub.mahfuz.navactivity.contactActivity;
import bd.edu.fcub.mahfuz.navactivity.developerActivity;
import bd.edu.fcub.mahfuz.navactivity.need_help;
import bd.edu.fcub.mahfuz.navactivity.resultActivity;
import bd.edu.fcub.mahfuz.navactivity.webportalActivity;
import bd.edu.fcub.mahfuz.parallaxActivity.officestaffsActivity;
import bd.edu.fcub.mahfuz.parallaxActivity.teachingstaffsActivity;
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.share_app) {
            ...
            sendIntent.putExtra(Intent.EXTRA_TEXT,
                    "Hey, check out FCUB android app at: https://play.google.com/store/apps/details?id=bd.edu.fcub.mahfuz");
